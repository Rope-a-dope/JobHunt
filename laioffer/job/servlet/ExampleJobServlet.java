...
public class ExampleJobServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        response.setContentType("application/json");
        ObjectMapper mapper = new ObjectMapper();
        ExampleCoordinates coordinates = new ExampleCoordinates(57.485130, -102.148316);
        ExampleJob job = new ExampleJob("Data Scientist", 166456, "Apr 1, 2021", false, coordinates);
        response.getWriter().print(mapper.writeValueAsString(job));
    }
}
